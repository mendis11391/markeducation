                            ...
                            <div class="content">
                                <table class="table" id="studentsList">
									...
									<tbody data-bind="foreach:studentsList">
									  <tr>
                                        <!-- ko if: $root.aLogin -->
                                        <td><input name="selectedStudentsForDeletion" type="checkbox" data-bind="value: certificateNumber"/></td>
                                        <!-- /ko -->
                                        <td><a href="javascript:;" target="_blank" class="viewProfile">View Profile</a></td>
                                        ...
                                        <!-- ko if: $root.aLogin -->
                                        <td><a href="javascript:;" id="editStudent"><i class="fa fa-pencil"></i></a></td>
                                        <td><a href="javascript:;" id="deleteStudent"><i class="fa fa-trash text-danger"></i></a></td>
                                        <!-- /ko -->
                                      </tr>
                                    </tbody>
								</table>
